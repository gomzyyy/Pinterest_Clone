...
import FriendListItemFollowers from "./components/FriendListItem/friendListItemFollowers";

const FollowingPage = () => {
  const f: any = useSelector((s: RootState) => s.admin.admin?.followers);
      ...
      {searchResult.length !== 0 ? (
        <FlatList
          ...
          renderItem={({ item, index }) => (
            <FriendListItemFollowers item={item} />
          )}
        />
      ) : (
        <View
